# Build Script for KenTools Steam Plugin
# Creates a ZIP file ready for distribution

param(
    [string]$OutputName = "kentoolsplugin.zip",
    [switch]$Clean
)
...
Write-Host "=== KenTools Build Script ===" -ForegroundColor Cyan
...
$TempZip = Join-Path $env:TEMP "kentools_build_$(Get-Date -Format 'yyyyMMddHHmmss').zip"
